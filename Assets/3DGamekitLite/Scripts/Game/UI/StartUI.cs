...
namespace Gamekit3D
{
    public class StartUI : MonoBehaviour
    {
        ...
        protected float m_LastPauseTime = -1f;
        protected const float k_PauseCooldown = 0.3f; // Prevent rapid pause toggling
        ...
        void Update()
        {
            ...
            {
                // Only allow pause toggle if enough time has passed since last toggle
                if (Time.unscaledTime - m_LastPauseTime > k_PauseCooldown)
                {
