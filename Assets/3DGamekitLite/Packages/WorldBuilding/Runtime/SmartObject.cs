...
namespace Gamekit3D.WorldBuilding
{
    ...
    public class SmartObject : MonoBehaviour
    {
        ...
        void Update()
        {
            // NOTE: This component performs multiple Physics.Raycast calls and toggles colliders.
            // Running that in Edit Mode can stall the editor (e.g., when opening Project Settings).
            // We only need this logic during Play Mode.
